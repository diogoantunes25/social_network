...
public class RenderDocumentSummary extends AttachmentVisitor {
  ...
  private String renderFields(Email msg) {
    return msg.getKey() + "|" + msg.getFrom() + "|" + msg.getTo() + "|" + msg.getSubject() + "|"
        + msg.getNumberOfAttachments();
  }
  ...
  private String renderFields(Publication pub) {
    return pub.getKey() + "|" + pub.getPositiveVotes() + "|" + pub.getNegativeVotes() + "|" + pub.getNumberOfComments();
  }
